...
export class FileService {
  ...
  //Atributes
  url: string = 'https://dragongallery-backend-production.up.railway.app/file'//API URL
  httpOptions = {
  ...
  public rename(file:any, name:string): Observable<any>{
    ...
    return this.http.post<any>(this.url + '/rename?name=' + name, file, this.httpOptions);
  }
